...
@Testcontainers
public class MariaDB_10_3_28_Test extends MariaDBTestBase {
    private Logger logger = LoggerFactory.getLogger(getClass());

    @Container
    public MariaDBContainer mariaDB = (MariaDBContainer) new MariaDBContainer("mariadb:10.3.28")
            .withConfigurationOverride("conf.d")
            .withInitScript("init.sql");
    
    @Test
    void test10_3_28() throws SQLException, InterruptedException {

...
@Testcontainers
public class MariaDB_10_4_12_Test extends MariaDBTestBase {
    private Logger logger = LoggerFactory.getLogger(getClass());

    @Container
    public MariaDBContainer mariaDB = (MariaDBContainer) new MariaDBContainer("mariadb:10.4.12")
            .withConfigurationOverride("conf.d")
            .withInitScript("init.sql");

    @Test
    void test10_4_12() throws SQLException, InterruptedException {

...
@Testcontainers
public class MariaDB_10_5_9_Test extends MariaDBTestBase {
    private Logger logger = LoggerFactory.getLogger(getClass());

    @Container
    public MariaDBContainer mariaDB = (MariaDBContainer) new MariaDBContainer("mariadb:10.5.9")
            .withConfigurationOverride("conf.d")
            .withInitScript("init.sql");
    
    @Test
    void test10_5_9() throws SQLException, InterruptedException {
